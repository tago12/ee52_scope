...
module sopc_scope_sys_rom #(
		...
		output wire        tcm_read_out,         //   tcm.read_out
	...
	altera_tristate_controller_aggregator #(
		...
		.clk                    (clk_clk),                                         //                       clk.clk
		.reset                  (reset_reset),                                     //                     reset.reset
		.tcm0_read              (tcm_read_out),                                    // tristate_conduit_master_0.read_out
		...
		.av_read                (slave_translator_avalon_anti_slave_0_read),       //            avalon_slave_0.read
		.av_chipselect          (slave_translator_avalon_anti_slave_0_chipselect), //                          .chipselect
