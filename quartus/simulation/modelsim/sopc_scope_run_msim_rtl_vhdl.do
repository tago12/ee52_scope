...
vcom -93 -work work {C:/Users/tago/Dropbox/OUT/EE 52/quartus/simulation/modelsim/display_ctrl.vht}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiii -L rtl_work -L work -voptargs="+acc"  display_ctrl
