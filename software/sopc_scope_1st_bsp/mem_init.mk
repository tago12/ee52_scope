...
# Memory: temp_ram
MEM_0 := sopc_scope_sys_temp_ram
$(MEM_0)_NAME := temp_ram
...
$(MEM_0)_HIERARCHICAL_PATH := temp_ram
$(MEM_0)_WIDTH := 8
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: temp_ram
temp_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
